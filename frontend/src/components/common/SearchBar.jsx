    ...
    <div className={`flex items-center justify-center w-full transition-all duration-300 ${isOpen ? "absolute top-0 left-0 bg-black h-24 z-50" : "w-auto"}`}>
        {
            isOpen ?(
                ...
                onSubmit={handleSearch}>
                    ...
                    <input type="text" placeholder='Search' value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className='px-4 py-2 pl-2 pr-12 rounded-lg focus:outline-none w-full placeholder:text-white text-white border border-gpsfdk-golden'/>
